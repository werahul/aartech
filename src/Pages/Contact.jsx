    ...
    return (
        <>
            ...
            <div className="mainPage lg:px-20 lg:mt-[4rem] lg:py-20 px-5 py-10 ">
                <div className="title text-4xl   font-antonio lg:mt-0 mt-20">
                    Contact Us
                </div>
                ...
                <div className="title text-4xl  font-antonio lg:mt-20 mt-10">
                    Email
                </div>
                <div className="emailLinks">
                    <div className="generic flex space-x-8 font-Barlow lg:mt-9 mt-6">
                        <h2 className='text-box-red text-[16px] lg:text-2xl lg:w-60 w-32 leading-6'>GENERIC QUERY</h2>
                    ...
                    <div className="seles flex space-x-8 font-Barlow">
                        <h2 className='text-box-red text-[16px] lg:text-2xl  lg:w-60 w-[7.7rem]'>SALES QUERY</h2>
                        <a href="mailto:sales@aartechsolonics.com"><h2 className=" text-[16px] lg:text-2xl font-semibold">sales@aartechsolonics.com</h2></a>
                    </div>
                </div>
                <div className="title text-4xl  font-antonio lg:mt-20 mt-10 lg:mb-9 mb-6">
                    Address & Phone
                </div>
                    ...
                    <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-60 py-4 px-4 " >
                        ...
                        <div className="boxContent flex flex-col leading-[26px] space-x-10 font-[400]">
                            <ul className='list-disc ml-9 '>
                                <a href="https://goo.gl/maps/NYPZGaFHh2MLaXMK8" target='_blank'><li className='font-Barlow  lg:w-[320px] lg:text-[20px] my-4  text-foot-blue'>“Ashirwad” E-2/57, Arera Colony, Bhopal, Madhya Pradesh (M.P.) India 462016</li></a>
                                ...
                                <a href="tel: +919752531167 "><li className='font-Barlow lg:text-[20px] my-4 text-foot-blue'>Mob No.+91-9752531167, <a href="tel:+919993091167"><span>9993091167</span></a></li></a>
                            </ul>
                        </div>
                    </div>
                    <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-60 py-4 px-4" >
                        ...
                        <div className="boxContent flex flex-col leading-[26px] lg:space-x-10 font-[400] ">
                            <ul className='list-disc ml-8 '>
                                ...
                                <a href="tel:+919993091168"><li className='font-Barlow lg:text-[20px] w-[105%] my-4 text-foot-blue'>Mob No. +91-9993091168,<a href='tel:+917389905790'><span>7389905790 </span></a></li></a>
                            </ul>
                        </div>
                    </div>
                    <div className="addressbox border-[1px] border-black w-[100%] lg:h-[323px] h-60 py-4 px-4 " >
                        ...
                        <div className="boxContent flex flex-col leading-[26px] lg:space-x-10 font-[400] ">
                            <ul className='list-disc ml-9  '>
                                ...
                                <a href="tel:+919418509967"><li className='font-Barlow lg:text-[20px] my-4 text-foot-blue'>
