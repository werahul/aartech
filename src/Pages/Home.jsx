...
const Home = () => {
  ...
  return (
    <>
      <Navbar />
      <Header />
      <div className="fullPage 2xl:px-[120px] lg:px-20 lg:pb-[74px]  lg:pt-20  w-[100%] py-10 px-5 mr-[83px]" >
      ...
      <div className="fullPage 2xl:px-[120px] lg:px-20 lg:py-[80px] w-[100%] p-5">
