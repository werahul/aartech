...
const AnnouncementPage = () => {
  return (
    <>
    <Navbar/>
    <div className="lg:py-20 lg:px-20  pt-20 px-5 lg:mt-0 mt-5 ">
    <div className="  lg:mt-20 text-black lg:text-[28px] text-[20px] font-Barlow font-bold lg:leading-9 leading-6">Aartech bags supply order to deliver Uacapacitor-based systems to Indian Army </div>
    ...
    <img src={anImg1} alt="" className='w-full' /></div>
    <div className=" text-black lg:text-xl text-[18px] font-normal font-Barlow leading-relaxed lg:mt-8 mt-4">Aartech Solonics Limited announced on 26 April 2021 that it has bagged a prestigious supply order of an undisclosed amount from the Indian Army for supply of its state-of-the-art KranKing® Uacapacitor based Systems for ‘A’ Vehicles. KranKing® Uacapacitor based Systems for ‘A’ Vehicles are extremely effective in the starting operations of Tanks/ICVs (type ‘A’ as well as type ‘B’ Vehicles), particularly in High Altitude Areas under extremely low temperature conditions in which batteries fail to perform. They have a 10x life, can handle 100x number of charge-discharge cycles and can be charged almost instantly compared to present day battery options in use. It also comes with various advanced features for testing, monitoring and protection; and includes independent energy harvesting sources to ensure engine starting under emergency situations. <br /><br />

    Amit Raje, Chairman and Managing Director and also the CTO of the company, said on the occasion, “It is a matter of great honour to have received an opportunity to serve the Indian Army. During trials we have closely worked alongside the ranks and empathized with the numerous pain points in real world field situations. Our UCAP SSD (System Solution Division) Team and Industrial Research, Design & Development (IRDD) Team, in collaboration with our 100% subsidiary FaraDigm® Uacapacitors Team have applied lot of innovative design thinking to overcome these problems in a very effective and efficient manner; which have found lot of appreciation and acceptance by its users through numerous field trials and demonstrations.”<br /><br />
