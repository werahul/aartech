    ...
    <div className="my-8">
      ...
      <div className="lg:flex justify-center items-center hidden">
        ...
        <div className="h-[0px] w-[48%] border border-slate-900 lg:flex items-center justify-evenly mt-6 hidden ml-auto ">
          ...
          <div className="w-8 h-8 bg-white rounded-full border absolute right-[14%] 2xl:right-[13%] border-red-700 cursor-pointer" ></div>
        </div>
      </div>
      <div className={`yearSection1 flex items-center justify-center lg:mt-8 font-Barlow -mt-36 ${currentImageIndex === 0 ? '' : 'hidden'}`}>
      ...
      <div className="">
        ...
        <div className={`section3 h-[30px] text-center text-foot-blue lg:text-xl font-Barlow text-base px-10 lg:font-normal font-medium leading-7 mt-2 lg:mb-0 -mb-14 ${currentImageIndex === 3 ? '' : 'hidden'}`}>Expanded to Parwanoo Unit Operations</div>
