        ...
        <>
            <div className="lg:flex justify-between items-center">
                ...
                <div className="lg:flex flex-col justify-between  lg:w-[80%] ">
                    ...
                    <div className=" font-Barlow lg:font-normal font-medium lg:leading-7 text-lightBlack lg:w-[820px] lg:text-[20px] text-base w-auto leading-[22.4px]  ">Aartech Solonics was founded in 1985 and was converted into a public limited company in 1992. The mission at the time of inception was to be an Application Engineering Specialist. We are trusted by government agencies and policy makers of many countries for bringing in our future ready mindset and the right techniques for the challenges at hand. <br className='lg:block hidden' /><br />
                ...
                <div className="lg:w-[324px] w-auto h-[324px]">
                    <CarouselAbout />
                </div>
