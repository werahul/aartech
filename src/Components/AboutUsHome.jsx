        ...
        <>
            <div className="sm:flex justify-between items-center ">
                ...
                <div className="lg:flex flex-col justify-between  lg:w-[80%] ">
                    ...
                    <Link to="/about"> <button className="lg:w-[189px] w-[145px] sm:w-[120px] whitespace-nowrap lg:h-[49px] h-[44px] border-[1px] border-black lg:text-[18px] sm:text-[12px] font-semibold lg:px-[39px] px-[20px] lg:mb-0 mb-4 lg:mt-[28px] mt-4 font-Barlow text-base"  >KNOW MORE</button></Link>
                </div>
