...
const Services = () => {
    return (
        <>
            ...
            <div className="box border-[1px] border-black lg:w-full  lg:h-auto lg:px-8  lg:py-[52px] px-4 py-6">
                ...
                <div className=" lg:flex gap-x-[96px] lg:space-y-0  space-y-4">
                    <div className="">
                        <div className="lg:text-[20px] text-[16px] text-foot-blue font-semibold font-Barlow  lg:mb-[28px] mb-4 ">Manufacturing Hubs</div>
                    ...
                    <div className="">
                        <div className="lg:text-[20px] text-[16px] text-foot-blue font-bold font-Barlow">Quality Assurance :</div>
            ...
            <div className="lg:flex lg:space-x-6 lg:space-y-0 space-y-6 mt-6 lg:mb-0 mb-[14px]">
                ...
                <div className="border-[1px] border-black w-full lg:h-auto  lg:px-8 lg:py-[52px]  px-4 py-6">
                ...
                <div className="border-[1px] border-black lg:w-full lg:h-auto lg:px-8 lg:py-[52px] px-4 py-6 ">
