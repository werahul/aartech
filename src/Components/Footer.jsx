...
const Footer = () => {
  return (
    <>
      <div className="mainFOOT 2xl:px-[120px] lg:px-20 lg:pt-14 lg:pb-5 pb-5 pt-10 px-6 py-10 bg-foot-blue h-auto text-white z-10 sm:px-10">
        <div className="footsec lg:flex justify-between items-start ">
          <div className="first-col lg:flex space-x-20">
            <div className="footImg mb-8 -mt-3 lg:block flex justify-between items-start">
              <div className="">
                <img src={footImg} alt="" />
                <div class="w-[152px] h-[37px] text-white text-base font-normal font-Barlow leading-tight lg:mt-4 mt-2">Living Passion through Engineering</div>
              </div>
